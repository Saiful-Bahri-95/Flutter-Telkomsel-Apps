...
TextStyle bottomNavText = GoogleFonts.poppins(
  color: greyColor,
  fontSize: 12,
  fontWeight: bold,
);
...
// REGULAR TEXT
TextStyle regulerText10 = GoogleFonts.poppins(
  fontSize: 10,
  fontWeight: reguler,
);
TextStyle regulerText12 = GoogleFonts.poppins(
  fontSize: 12,
  fontWeight: reguler,
);
TextStyle regulerText13 = GoogleFonts.poppins(
  fontSize: 13,
  fontWeight: reguler,
);
TextStyle regulerText14 = GoogleFonts.poppins(
  fontSize: 14,
  fontWeight: reguler,
);
...
// SEMIBOLD TEXT
TextStyle semiBoldText13 = GoogleFonts.poppins(
  fontSize: 13,
  fontWeight: semiBold,
);
